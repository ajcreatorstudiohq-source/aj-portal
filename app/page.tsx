...
// ... keep original helper funcs like handleImageClick ...
    ...
    <div className="fixed inset-0 z-[300] bg-black flex flex-col h-screen overflow-hidden">
        {!selectedGame ? (
            <div className="p-8 overflow-y-auto flex-1">
                <button onClick={() => setScreen('hub')} className="text-cyan-400 font-bold mb-10 tracking-widest uppercase transition-all hover:brightness-125 flex items-center gap-2"><ArrowLeft size={20}/> BACK TO HUB</button>
