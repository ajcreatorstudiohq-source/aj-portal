...
export default function AJSuperPortal() {
  ...
  useEffect(() => {
    const handleBalanceUpdate = async (e: any) => {
      ...
      alert(`✅ Mubarak Ali! ${amount} Coins Wallet mein add ho gaye!`);
    };
  ...
  const handlePurchase = async () => {
    if (purchaseMethod === 'Binance Pay (USDT)') {
      ...
      alert(`✅ Order Sent! Send proof to Ali on WhatsApp.`);
      setWalletTab('main');
    }
  };
           ...
           <div className="w-full max-w-md bg-[#111] border border-white/10 p-10 rounded-3xl text-center shadow-2xl">
              ...
              {walletTab === 'purchase' && (
                <div className="flex flex-col gap-5 text-left">
                  ...
                  <button onClick={handlePurchase} className="bg-cyan-500 py-4 rounded-xl font-black uppercase mt-2">Pay Now</button>
        ...
        <div className="fixed inset-0 z-[200] bg-black p-10 flex flex-col items-center overflow-y-auto">
            ...
            <div className="flex flex-col gap-6 w-full max-w-md">
                {['AJ TikReels', 'AJ Pulse', 'AJ Live Chat'].map((module) => (
                   <div key={module} onClick={() => alert(`${module} starting in Month 2!`)} className="bg-white/5 border border-white/10 p-10 rounded-[2rem] hover:border-pink-500 cursor-pointer text-center">
