  ...
  useEffect(() => {
    ...
    const activate = () => {
      ...
      if (!box) {
        ...
        box.className =
          'w-full max-w-md min-h-[220px] flex items-center justify-center rounded-xl border border-indigo-500/20 bg-[#12121a]';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(160deg, rgba(99,102,241,0.12) 0%, transparent 35%, rgba(34,211,238,0.08) 100%)',
        }}
      />

      <div className="relative z-10 inline-flex items-center gap-2 rounded-full border border-sky-400/25 bg-black/35 backdrop-blur-md px-3 py-1">
        <span className="h-1.5 w-1.5 rounded-full bg-sky-400 animate-pulse" />
        <span className="text-[9px] font-black uppercase tracking-[0.22em] text-sky-100/90">
          Sponsored
        </span>
      </div>
      ...
      >
        <div className="absolute inset-0 pointer-events-none flex flex-col items-center justify-center gap-2 px-6">
          <div className="w-10 h-10 rounded-xl border border-indigo-400/30 bg-indigo-500/10 flex items-center justify-center">
